...
if (isset($_SESSION['khachhang_id'])) {
    ...
    $sql = "SELECT namekh FROM khachhang WHERE id = ?";
    ...
    $sql = "SELECT nameadmin FROM adminshop WHERE id = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("i", $id);
    $stmt->execute();
    $result = $stmt->get_result();
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            ...
            <form class="d-flex" action="search_results.php" method="GET">
                <input class="form-control me-2" type="search" placeholder="Tìm kiếm sản phẩm..." aria-label="Search" name="query" required>

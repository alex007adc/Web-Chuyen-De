...
// Lấy trung bình số sao và số lượt đánh giá
...
// Hiển thị bình luận
$sql_count = "SELECT COUNT(*) AS total FROM danhgia_binhluan WHERE sanpham = ? AND duyet = 1";
$stmt_count = $conn->prepare($sql_count);
$stmt_count->bind_param("i", $id);
$stmt_count->execute();
$result_count = $stmt_count->get_result()->fetch_assoc();
$total_comments = $result_count['total'];
...
$stmt_binhluan->bind_param("iii", $id, $offset, $comments_per_page);
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="container mt-4">
        ...
        <div class="mt-3" id="binhluan-container">
            <?php while ($bl = $result_binhluan->fetch_assoc()): ?>
